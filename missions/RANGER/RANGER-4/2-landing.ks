...
local descentLongitude is
	//List(-10,-9). // PIONEER-4c
	//List(-99,-98). // PIONEER-4d
	//List(177,178). // PIONEER-4e
	//List(-42,-41). // PIONEER-4f
	List(80,81). // PIONEER-4g
...
function suicideBurn{parameter m,p.
	if SHIP:verticalSpeed >= 0 m["next"]().
	if TLM["timeToImpact"](50) <= MNV["GetManeuverTime"](SHIP:velocity:surface:mag) lock THROTTLE to 1.
